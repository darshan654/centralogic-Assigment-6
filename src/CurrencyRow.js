...
function CurrencyRow(props) {
  ...
  return (
    <div className="container p-4 bg-gray-300 rounded-md">
      ...
      <input type='number' id='from' value={myValue} onChange={handleInputChange} className="border border-black rounded-md px-3 py-2 mb-2" />
      <select onChange={handleSelectChange} className="border  border-black rounded-md px-3 py-2">
        {options.map((cname) =>
